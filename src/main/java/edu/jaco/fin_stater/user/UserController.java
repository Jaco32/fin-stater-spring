    ...
    public void createUser(@RequestHeader("mode") String mode, @PathVariable String name) {
        ...
        session.doWork(new Work() {
            ...
            public void execute(Connection hibernateConnection) throws SQLException {
                ...
                statement.execute("create table balance (expenses float(53) not null, income float(53) not null, period_balance float(53) not null, from_date timestamp(6), id bigint not null, to_date timestamp(6), primary key (id))");
